...
{else}
	<div id="carrier_area" class="opc-main-block">
		<h1 class="page-heading step-num"><span class="numero">3</span> {l s='Delivery methods'}</h1>
	...
	{else}
		...
		{else}
			<div class="delivery_options_address">
				...
				{if $opc}
					<p class="carrier_title" style="margin-bottom:10px;">{l s='Leave a message'}</p>
					<div>
						<p style="margin:10px 0;">{l s='If you would like to add a comment about your order, please write it in the field below.'}</p>
