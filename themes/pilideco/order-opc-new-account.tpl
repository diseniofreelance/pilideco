<div id="opc_new_account" class="opc-main-block">
	...
	<h1 class="page-heading step-num"><span class="numero">2</span> {l s='Account'}</h1>
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
		<fieldset>
			<h3 class="page-subheading">{l s='¿Ya esta Registrado? Inicie Sesión'}</h3>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			<div class="box">
				<h3 id="new_account_title" class="page-subheading">{l s='¿es nuevo en Pilideco?'}</h3>
				<div id="opc_account_choice" class="row">
					<div class="col-xs-12 col-md-6">
						<p class="title_block" style="text-transform:uppercase;">{l s='Compre como Invitado'}</p>
						<p class="opc-button">
					...
					<div class="col-xs-12 col-md-6">
						<p class="title_block" style="text-transform:uppercase;">{l s='¡Cree su cuenta hoy mismo!'}</p>
						<!--<ul class="bullet">
